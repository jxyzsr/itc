...
#定义所需的非线性激活函数，使模型泛化能力更好
def Hswish(x,inplace=True):#Hard_swish
    return x * F.relu6(x + 3., inplace=inplace) / 6.
def Hsigmoid(x,inplace=True):#Hard_sigmoid
    return F.relu6(x + 3., inplace=inplace) / 6.


# Squeeze-And-Excite模块,注意力机制
...
class MobileNetV3_large(nn.Module):
    ...
    def __init__(self,num_classes):
        ...
        self.bn2=nn.BatchNorm2d(960)#正则化层，可以加快神经网络的训练速度
